 ...
 */
?>
<div class="all-services__subitem">
	<h6><?=$item["NAME"]?></h6>
...
<!--			<span><a href="#order-appointment" data-fancybox="" data-src="#order-appointment" class="serv-subitem-btn">записаться</a></span>-->
		<?endif;?>
		<?/*	<span><a href="<?= $item["DETAIL_PAGE_URL"] ?>?ID=<?= $item["ID"] ?>" class="serv-subitem-btn">записаться</a></span>*/ ?>
		<span class="price">
			<?if($item['PROPERTIES']['PRICE_BEGIN']['VALUE_ENUM_ID']==122){?>
				от&nbsp;
			<?}?>
