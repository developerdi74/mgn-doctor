...
foreach($arResult['SECTIONS'] as &$arSection){
	...
	if($arSection['DETAIL_PICTURE']=="") continue;?>
	<div class="item main-directions__item" >
		<div class="direction-item-img">
			<img src="<?=CFile::GetPath($arSection['DETAIL_PICTURE']);?>" alt="<?=$arSection["NAME"]?>">
			<h5 class="direction-item__title"><?=$arSection['NAME']?></h5>
			<a href="<?=$arSection["SECTION_PAGE_URL"];?>" class="direction-item__link--hidden"></a>
		</div>
	</div>
<?}?>
