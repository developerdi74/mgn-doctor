            ...
            <div class="container  main-slider-container__nav">
                <div class="slider__nav navigation main-slider__nav">
                    <div class="slider__nav-prev">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/arrow-prev.svg" height="20" width="11" alt="prev">
                    </div>
                    <div class="slider__nav-next">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/arrow-next.svg" height="20" width="11" alt="next">
                    </div>
                </div>
            </div>
            ...
            <div class="owl-carousel owl-theme main-slider__owl" id="main-slider">
                <? foreach ($arResult["ITEMS"] as $arItem) : ?>
                    ...
                    <div class="item" style="background-image:url('<?= $arItem["PREVIEW_PICTURE"][$src] ?>');">
                        <div class="main-slider__item--mobile"
                             style="background-image:url('<?= $arItem["DETAIL_PICTURE"][$src2] ?>');">
