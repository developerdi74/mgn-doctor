...
<script>
  ...
  function DataFilterJS(config) {
    ...
    $(filterGroup + ', ' + filterNode + ', ' + filterNode + '.filter-me').css({
    ...
    $('.filter-node').on('click', function(e) {
        var target = $("#slider-doctor").offset().top-120;
    ...
    <div class="our-team__col our-team__col-table">
      <div class="our-team-directions filter-group">
        ...
        <? foreach ($arResult["ITEMS"] as $arSectItem) : ?>
          <a href="?SECTION_ID=<?= $arSectItem['ID'] ?>" class="our-team-directions__item filter-node <? if( in_array("4", $arSectItem["UF_AGE"]) && !in_array("3", $arSectItem["UF_AGE"])  ) echo "filter-me" ?>" data-filter='["<? if (in_array("4", $arSectItem["UF_AGE"])) echo "children" ?>", "<? if (in_array("3", $arSectItem["UF_AGE"])) echo "adult" ?>"]'><? echo $arSectItem['NAME'] ?></a>
        <?  endforeach; ?>
      </div>
    </div>

    <div class="our-team__col our-team__col--slider">



      <!-- Swiper -->
      <div id="slider-doctor" class="swiper-container two our-slider__team">
                      ...
                      <picture>
                        <?//prnt($arItem["PREVIEW_PICTURE"]);?>
                         ...
                         <?endif;?>
                            ...
                            <img src="" loading="lazy" height = "<?=$arItem["PREVIEW_PICTURE"]["HEIGHT"]?>" width = "<?=$arItem["PREVIEW_PICTURE"]["WIDTH"]?>" alt="<?=$arItem["PREVIEW_PICTURE"]["ALT"]?>">
                      </picture>
                    </div>
                  ...
                  <div class="specialists-item__content">
                    ...
                    <div class="specialists-item__admission">
                      ...
                      <div class="specialists-item__admission--time">
                        ...
                        <a href="" class="specialists-item__admission--link"><?= ConvertDateTime($arItem['DISPLAY_PROPERTIES']['DATE']['DISPLAY_VALUE'], "dd.mm в hh:mi", "ru"); ?></a>
                      </div>
                    </div>
