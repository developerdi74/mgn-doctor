...
?>
	...
	<section class="specialists-inner all-our-specialists">
		<div class="container">
			<div class="row page-row-middle">
				<h1 class="page-title specialists-inner__title all-our-specialists__title"><?$APPLICATION->ShowTitle();?></h1>
			</div>
		<?if($_SERVER['REQUEST_URI'] == '/detskie-vrachi/' or strpos($_SERVER['REQUEST_URI'], '/detskie-vrachi/?')!==false):
		?>
			<div class="row page-row-middle all-specialists">
					<a href="/doctors/"><button class="btn btn-spec-flt">Взрослые</button></a>
					<a href="/detskie-vrachi/"><button class="btn btn-spec-flt  active">Детские</button></a>
			</div>
		<? endif;?>
		<?
			define("AGE",110);
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_URL_TEMPLATES" => array(
			...
			"smart_filter" => "/detskie-vrachi/#SMART_FILTER_PATH#/apply/",
		),
