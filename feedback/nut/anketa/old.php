...
///в разработке для анкеты нутрициолога
/*
$pole = [
        "I. Вопросы общие"=>[
            "Имя, Фамилия:",
            ...
            "Вредные привычки (курение, алкоголь, наркомания, злоупотребление препаратами и т.д. – подробно расписать):",
            "Перечислите все болезни, которыми вы болели с детства:",
            "За последние 5 лет Вы находились на стационарном лечении, в том числе в условиях дневного стационара (стационара одного дня)? (если Да, укажите год, диагноз и проведенное лечение):",
            "Какие болезни у вас частые и повторяющиеся?",
            "Какие лекарства или БАДы вы принимаете в настоящее время или принимали в последние 3 месяца – подробно расписать?",
            "Принимаете ли гормональные препараты (оральные контрацептивы, гормональная терапия менопаузы и т.п.)?",
            ...
            "Ваш максимальный и минимальный вес в жизни? В каком весе чувствуете себя комфортно?",
            "",
            "",
            "",
            "",
